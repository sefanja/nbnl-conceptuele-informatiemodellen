...
| Energie-uitwisselingsregister | C.6.3.3. Energie-uitwisseling beheren |
| Energietoerekeningsregister | C.6.3.4. Marktverrekening faciliteren |
| Meetcomponentenregister | C.3.1.9. Netcomponent in levenscyclusbeheer opnemen |
...
| Toestemmingenregister | C.6.4.2. Toestemmingen beheren |